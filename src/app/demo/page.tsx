    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-4xl">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-3">Preview Dashboard</h1>
          <p className="text-gray-600 text-lg">
            Lihat tampilan dashboard User dan Technician dengan data demo
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Dashboard untuk pengguna yang ingin membuat order servis, melihat status order, dan tracking impact.
            </p>
            <ul className="space-y-2 text-sm text-gray-500">
              ...
              <li className="flex items-center">
                ...
                Tracking e-waste impact
              </li>
              <li className="flex items-center">
                <svg className="w-4 h-4 text-emerald-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                Cari teknisi terdekat
              </li>
            </ul>
          ...
          <Link
            href="/demo/technician"
            className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all p-8 border-2 border-transparent hover:border-blue-500"
          >
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-3">Technician Dashboard</h2>
            <p className="text-gray-600 mb-4">
              Dashboard untuk teknisi yang menerima dan menyelesaikan order servis dari pengguna.
            </p>
            <ul className="space-y-2 text-sm text-gray-500">
              <li className="flex items-center">
        ...
        <div className="mt-8 bg-amber-50 border border-amber-200 rounded-xl p-4 text-center">
          <div className="flex items-center justify-center mb-2">
            ...
            <span className="text-amber-800 font-semibold">Demo Mode</span>
          </div>
          <p className="text-amber-700 text-sm">
            Ini adalah preview dengan data demo. Untuk menggunakan fitur lengkap, silakan login terlebih dahulu.
          </p>
        </div>
      </div>
    </div>
