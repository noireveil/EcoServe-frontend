...
export function AuthForm() {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      const userId = user?.id || user?.ID || user?.Id || user?.user_id
      ...
      if (activeTab === "register" && role === "technician") {
        ...
        if (!techResponse.ok) {
          ...
          let errorMessage = "Failed to register technician profile"
          try {
      ...
      if (userRole === "technician" || (activeTab === "register" && role === "technician")) {
        await apiFetch("/api/technicians/performance")
                  ...
                  {!showOtpInput ? (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="w-full text-sm text-primary hover:underline disabled:text-muted-foreground disabled:no-underline mt-2"
                      >
